	...
	return (
		<ScrollingProvider>
					...
					<Grid container >
						<Grid item sm={12} md={6} lg={6} >
							<div item className="mainTitle">
								...
								<span className="x_font_w_1">  EQCoins</span>
								<span className="x_font_y_1"> to Buy Shares of <br />
									Investment Horses
								</span>
					...
					<Grid container>
						...
						<Grid item sm={12} lg={6} md={6}>
							<Item className="center_container center" >
								...
								<br />
								<span className="x_font_y_3">To Invest in Horses</span>
								<br />
								<span className="x_font_w_3">
									EQCoin is a token that offers a new solution to investing and earning income from real valuable horses.<br />
									It allows you to purchase ownership in horses that are acquired, trained, and flipped for profit.
									It provides a transparent,<br /> reliable and high-yielding way to invest in horses.
								</span>
			...
			<Container>
				...
				<div className="part3">
					<Item>
						<span className="x_font_y_3"><b>Roadmap</b> for EQCoin</span>
						<div className="space-double"></div>
						<Grid container justifyContent="center" alignItems="center" spacing={5}>
							<Grid item md={3} sm={12}>
								<span className="x_font_q_1">Phase 1</span>
								<InfoCard
									title="ICO"
									subtitle="QECOIN TOKEN LAUNCH"
									content={(<span>Whitepaper.<br /> Token Pre-sale. <br /> Exchange Listings. </span>)}
								/>
							</Grid>
							<Grid item md={3} sm={12}>
								<span className="x_font_q_1">Phase 2</span>
								<InfoCard
									title="LAUNCH"
							...
							<Grid item md={3} sm={12}>
								<span className="x_font_q_1">Phase 3</span>
								<InfoCard
									title="COMPLETION"
							...
							<Grid item md={3} sm={12}>
								<span className="x_font_q_1">Phase 4</span>
								<InfoCard
									title="EXPANSION"
